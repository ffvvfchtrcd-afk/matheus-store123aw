  ...
  return (
    <div className={cn('flex items-center border border-border rounded-lg overflow-hidden', className)}>
      <button
        ...
        className="w-10 h-10 flex items-center justify-center text-text-secondary hover:text-text-primary hover:bg-surface-tertiary transition-colors disabled:opacity-30 disabled:cursor-not-allowed active:scale-95"
      >
